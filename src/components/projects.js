  ...
  render() { 
    return ( 
        <div className = "container mt-5">
          <center><h1>Click on each to see github repo</h1></center>
          ...
          <div className = "row mt-4">
            ...
            <Card
               ...
               projectDescription = "Prima mea participare in cadrul Liga Ac Labs, unde am invatat elemente ale programarii web de la oameni din domeniu."
               publishDate = "28.05.2020"
              />
              </div>
